...
void I2C8_DevTx(vuint8_t module, vuint8_t dev, vuint8_t adr_byte, vuint8_t data_byte)
{
    I2C_start(module,dev,WRITE);
    I2C_write(module,adr_byte);
    I2C_write(module,data_byte);
    I2C_stop(module);
}

vuint8_t I2C8_DevRx(vuint8_t module, vuint8_t dev, vuint8_t adr_byte)
{
    vuint8_t data;
    I2C_start(module,dev,WRITE);
    I2C_write(module,adr_byte);
    data = I2C_read(module,dev);
    return data;
}

void I2C_DevTx(vuint8_t module, vuint8_t dev, vuint8_t adr_byte1, vuint8_t adr_byte2, vuint8_t data_byte)
{
    I2C_start(module,dev,WRITE);
    I2C_write(module,adr_byte1);
    I2C_write(module,adr_byte2);
...
vuint8_t I2C_DevRx(vuint8_t module, vuint8_t dev, vuint8_t adr_byte1, vuint8_t adr_byte2)
{
    vuint8_t data;
    I2C_start(module,dev,WRITE);
    I2C_write(module,adr_byte1);
