...
void* FeatureDescriptor::GetDataPtr()
{
   return mpData;
}

void* FeatureDescriptor::GetDataPtrPhys()
{
   return mpDataPhys;
}

int32_t FeatureDescriptor::GetSpan()
{
   return (int32_t)sizeof(Feature);
}

int32_t FeatureDescriptor::GetSize()
{
   return mMaxElements;
}

int32_t FeatureDescriptor::GetCount()
{
   return mNumElements;
}
...
Feature& FeatureDescriptor::GetFeature(int32_t ind) {
   if (ind >= mMaxElements || ind < 0)
