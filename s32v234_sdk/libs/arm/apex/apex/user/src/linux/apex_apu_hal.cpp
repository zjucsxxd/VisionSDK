...
{
    return apexdriver_apu_hal_RetMemSizes (apexID, apuconfig, pSmemSize, pCmemSize);
}
...
void RetApuInfoFromCmemIf (int apexID, int32_t    lApuId,
                           ...
                           uint32_t*   lpDmemSizeInBytes)
{
     return apexdriver_RetApuInfoFromCmemIf (apexID, lApuId,
                           lpCmemBroadcastReg,
                           lpPmemOffsetInBytes,
                           lpDmemOffsetInBytes,
                           lpDmemSizeInBytes);
...
{
    return ReturnPhysicalHwPtr (lApexID, lHwRegId);
}*/
