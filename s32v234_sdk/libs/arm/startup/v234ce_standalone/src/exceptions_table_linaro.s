...
irq_handler:
     ...
     mov x29, sp
     str x0, [x29,#32]               // After considering space allotted for x29,x30 in line 92 */
     str x1, [x29,#40]
     str x2, [x29,#48]
     str x3, [x29,#56]
     str x4, [x29,#64]
...
#     str     x3,[x0]         //@; Update End of Interrupt register with original value from ICCIAR
 END_IRQ_HLDR:
     ldr x0, [x29,#32]
     ldr x1, [x29,#40]
     ldr x2, [x29,#48]
     ...
     ldr x8, [x29,#96]
     ldp x29,x30, [sp],#192
     str     x9,[x10]         //@; Update End of Interrupt register with original value from ICCIAR    
