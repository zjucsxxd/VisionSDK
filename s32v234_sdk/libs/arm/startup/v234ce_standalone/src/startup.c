...
#include "mmap.h"
#include <oal.h>
#include "../../../apex/apex/kernel/include/standalone/apexdriver_hw_reg_user.h"
#include "../../../apex/apex/user/include/apex_global_hal.h"
#include <gic400.h>
#include <s32vs234.h>
#include <pll.h>
#include <i2c.h>
...
{
	// Only dummy function
	//if (&__init_array_start__ + 0x8 == &__init_array_end__) return;
