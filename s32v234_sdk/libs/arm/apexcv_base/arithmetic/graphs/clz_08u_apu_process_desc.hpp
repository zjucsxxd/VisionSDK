...
#ifndef CLZ_08U_APU_PROCESS_DESC_HPP
#define CLZ_08U_APU_PROCESS_DESC_HPP


#include <acf_process_desc_apu.hpp>
//#include "clz_08u_graph.hpp"
...
#define CLZ_08U_PI	CLZ_08U
#define CLZ_08U_PIN	XSTR(CLZ_08U_PI)
...
public:
	void Create()
	{
		Initialize(mGraph, CLZ_08U_PIN);
		SetInputChunkSize(GR_IN_0, ARITHM_CHUNK_WIDTH, ARITHM_CHUNK_HEIGHT);
	}

	//clz_08u_graph mGraph;
	graphClassName(CLZ_08u_K) mGraph;
};


#ifdef APEX2_EMULATE
REGISTER_PROCESS_TYPE(CLZ_08U_PI, clz_08u_apu_process_desc)
#endif
