...
#ifndef _APEXCV_INTERP_BICUBIC_GRAYSCALE_HPP_
#define _APEXCV_INTERP_BICUBIC_GRAYSCALE_HPP_
...
*  the APU implementation of bicubic on the host.
***********************************************************************************/

class apexcv_interp_bicubic_grayscale
{
   public:
/*!*********************************************************************************
*  \brief Default constructor.
***********************************************************************************/
      apexcv_interp_bicubic_grayscale()  {};
...
***********************************************************************************/                     
      int Initialize(       DataDescriptor& lInput0,
                            ...
                            DataDescriptor& x_offset,
                            DataDescriptor& y_offset );
...
***********************************************************************************/
      INTERP_BICUBIC_GRAYSCALE  mProcess;
};

#endif /* _APEXCV_INTERP_BICUBIC_GRAYSCALE_HPP_ */
