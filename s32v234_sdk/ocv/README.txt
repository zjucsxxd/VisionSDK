...
=======================================
  ...
  1) Extract the OpenCV 2.4.10 sources into SDK_ROOT/../opencv_src directory
  -------------------------------------------------------------------
  ...
  --------------
    - Switch into SDK_ROOT/../opencv_src directory 
      - Apply available patch by executing 
        "patch -p1 -i SDK_ROOT/ocv/integrity_2.4.10.patch"
  ...
  ----------------------------------
    - Switch into SDK_ROOT/ocv/cmake-<platform> directory
...
====================================
  ...
  - To enable use of ffmpeg libraries overwrite file 
    ...
    SDK_ROOT/ocv/OpenCVFindLibsVideo.cmake.
  ...
  ----------------------------------
    - Switch into SDK_ROOT/ocv/cmake-v234ce-gnu-linux
    - Execute build.sh script
      - A default path 
...
In such case it is recomended to:
  ...
  - run sh build.sh script from s32v234_sdk/ocv directory directly in Windows
    command line.
