...
echo $SDK_ROOT/ffmpeg/linux-arm64/include
...
cmake 												\
  -D CMAKE_INSTALL_PREFIX=$SDK_ROOT/ocv/linux-arm64						\
  -D CMAKE_TOOLCHAIN_FILE=$TOOLCHAIN								\
  -D WITH_QT=OFF 										\
  -D WITH_FFMPEG=ON 										\
  -D FFMPEG_LIB_DIR=$SDK_ROOT/ffmpeg/linux-arm64/lib						\
  -D FFMPEG_INCLUDE_DIR=$SDK_ROOT/ffmpeg/linux-arm64/include					\
