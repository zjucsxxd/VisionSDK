...
int floydWarshallPass__3 (  int nxt,
...
extern int  floydWarshallPass__3__md[];

// SET ARGUMENT FUNCTION DECL
void floydWarshallPass__3__set(void chess_storage(DMb)* ctx, cl_argument* args);


// KERNEL METADATA
CL_KRNL_MD floydWarshallPass_md = 
{
   0,0,0,0,                   // required wg size
   4,        // number of arguments
   3,                         // kernel mode
   1,1,2,2,0,0,0,0,           // arg addr space type
   0,0,0,0,0,0,0,0,           // arg access type
   floydWarshallPass__3__md,
   (int32_t)(&floydWarshallPass__3),
   (int32_t)(&floydWarshallPass__3__set),
