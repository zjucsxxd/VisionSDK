...
int MedianFilterBitonic__3 (  int nxt,
...
extern int  MedianFilterBitonic__3__md[];

// SET ARGUMENT FUNCTION DECL
void MedianFilterBitonic__3__set(void chess_storage(DMb)* ctx, cl_argument* args);


// KERNEL METADATA
CL_KRNL_MD MedianFilterBitonic_md = 
{
   ...
   MedianFilterBitonic__3__md,
   (int32_t)(&MedianFilterBitonic__3),
   (int32_t)(&MedianFilterBitonic__3__set),
