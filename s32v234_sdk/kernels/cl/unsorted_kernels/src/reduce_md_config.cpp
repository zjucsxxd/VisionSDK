...
extern int  reduce__3__md[];

// SET ARGUMENT FUNCTION DECL
void reduce__3__set(void chess_storage(DMb)* ctx, cl_argument* args);


// KERNEL METADATA
CL_KRNL_MD reduce_md = 
{
