...
int MedianFilterBitonicAsync__3 (  int nxt,
...
extern int  MedianFilterBitonicAsync__3__md[];

// SET ARGUMENT FUNCTION DECL
void MedianFilterBitonicAsync__3__set(void chess_storage(DMb)* ctx, cl_argument* args);


// KERNEL METADATA
CL_KRNL_MD MedianFilterBitonicAsync_md = 
{
   ...
   MedianFilterBitonicAsync__3__md,
   (int32_t)(&MedianFilterBitonicAsync__3),
   (int32_t)(&MedianFilterBitonicAsync__3__set),
