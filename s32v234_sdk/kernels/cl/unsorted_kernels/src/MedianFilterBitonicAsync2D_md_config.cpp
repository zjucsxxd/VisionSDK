...
int MedianFilterBitonicAsync2D__3 (  int nxt,
...
extern int  MedianFilterBitonicAsync2D__3__md[];

// SET ARGUMENT FUNCTION DECL
void MedianFilterBitonicAsync2D__3__set(void chess_storage(DMb)* ctx, cl_argument* args);


// KERNEL METADATA
CL_KRNL_MD MedianFilterBitonicAsync2D_md = 
{
   ...
   MedianFilterBitonicAsync2D__3__md,
   (int32_t)(&MedianFilterBitonicAsync2D__3),
   (int32_t)(&MedianFilterBitonicAsync2D__3__set),
