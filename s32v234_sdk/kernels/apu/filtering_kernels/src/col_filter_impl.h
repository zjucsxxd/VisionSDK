...
/*!
* \file col_filter_impl.h
* \brief Filter an image column with a certain filter.
* \addtogroup col_filter
* @{
****************************************************************************/

#ifndef _COL_FILTER_IMPL_H_
#define _COL_FILTER_IMPL_H_
...
*  final result.
*  \snippet col_filter_impl.c rounding
*
...
*  \snippet col_filter_impl.c source offset
*
...
*  \snippet col_filter_impl.c weighted sum
***********************************************************************************/
...
#endif   // ifndef _COL_FILTER_IMPL_H_
