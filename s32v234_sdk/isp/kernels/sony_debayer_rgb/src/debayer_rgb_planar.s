...
.global debayer_rgb_planar_start
debayer_rgb_planar_start:
	...
	mov gpr2,490 // gain b, (490/2) for 15 bit output
        ...
        done debayer_rgb_planar_d0_g,i
debayer_rgb_planar_d0_g:
        done debayer_rgb_planar_d1_g,i
debayer_rgb_planar_d1_g:
...
debayer_rgb_planar_loop0:
	mulh out0,ina1,gpr0 // r
	//mulh out1,ina0,gpr1 // g
	mulh out2,ina3,gpr2 // b
	mov out1,scaled //g

	done debayer_rgb_planar_evenlodd,ixo
debayer_rgb_planar_evenlodd:
	done debayer_rgb_planar_loop0,i
	
//	halt

.global debayer_rgb_planar_end
debayer_rgb_planar_end:
