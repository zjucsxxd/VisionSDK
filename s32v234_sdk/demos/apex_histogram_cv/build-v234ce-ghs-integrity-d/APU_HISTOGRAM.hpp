...
//SCENARIO LIST*************************************************
static acf_scenario_buffer_data gScenarioBufferData0_APU_HISTOGRAM[] = {{8, 8, 2, 0, 0x0}, {256, 1, 1, 0, 0x0}, {256, 1, 1, 0, 0x0}};

static acf_scenario_kernel_data gScenarioKernelData0_APU_HISTOGRAM[] = {{0}, {0}};

static acf_scenario gScenarioArray_APU_HISTOGRAM[] = {
{0, 0, 1152, 1024, 0, gScenarioBufferData0_APU_HISTOGRAM, 30, gScenarioKernelData0_APU_HISTOGRAM, 4}
};
...
public:
   ...
   int32_t Initialize()
   {
      ...
      if (!Initialized()) //initialization steps that only need to occur once
      {
         ...
         AddPort("INPUT_0", ICP_DATATYPE_08U, 1, 1, 8, 8, 0, 0, 0, 0, 0, 0, 0, 0x0);
