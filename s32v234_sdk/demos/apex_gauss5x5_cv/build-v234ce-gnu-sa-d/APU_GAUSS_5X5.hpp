...
//SCENARIO LIST*************************************************
static acf_scenario_buffer_data gScenarioBufferData0_APU_GAUSS_5X5[] = {{8, 16, 4, 0, 0x2222}, {8, 16, 2, 1, 0x0}};

static acf_scenario_kernel_data gScenarioKernelData0_APU_GAUSS_5X5[] = {{1}};

static acf_scenario gScenarioArray_APU_GAUSS_5X5[] = {
{0, 0, 1072, 0, 1, gScenarioBufferData0_APU_GAUSS_5X5, 20, gScenarioKernelData0_APU_GAUSS_5X5, 2}
};
...
public:
   ...
   int32_t Initialize()
   {
      ...
      if (!Initialized()) //initialization steps that only need to occur once
      {
         ...
         AddPort("INPUT_0", ICP_DATATYPE_08U, 1, 1, 8, 16, 0, 0, 0, 0, 0, 0, 0, 0x2020202);
         AddPort("OUTPUT_0", ICP_DATATYPE_08U, 1, 1, 8, 16, 1, 0, 0, 0, 0, 0, 1);
