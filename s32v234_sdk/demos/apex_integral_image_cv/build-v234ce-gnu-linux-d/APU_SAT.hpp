...
//SCENARIO LIST*************************************************
static acf_scenario_buffer_data gScenarioBufferData0_APU_SAT[] = {{6, 2, 2, 0, 0x0}, {6, 2, 10, 0, 0x6565}, {6, 2, 2, 3, 0x0}, {6, 2, 1, 0, 0x0}};

static acf_scenario_kernel_data gScenarioKernelData0_APU_SAT[] = {{0}, {3}};

static acf_scenario gScenarioArray_APU_SAT[] = {
{0, 0, 2204, 0, 3, gScenarioBufferData0_APU_SAT, 40, gScenarioKernelData0_APU_SAT, 4}
};
...
public:
   ...
   int32_t Initialize()
   {
      ...
      if (!Initialized()) //initialization steps that only need to occur once
      {
         ...
         AddPort("INPUT_0", ICP_DATATYPE_08U, 1, 1, 6, 2, 0, 0, 0, 0, 0, 0, 0, 0x6050506);
         AddPort("OUTPUT_0", ICP_DATATYPE_32U, 1, 1, 6, 2, 1, 0, 0, 0, 0, 0, 1);
         AddPort("OUTPUT_1", ICP_DATATYPE_08U, 1, 1, 6, 2, 1, 0, 0, 0, 0, 0, 2);
