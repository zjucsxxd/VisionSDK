...
ACL_APP_LIBS := $(ACL_KERNEL_LIBS)		\
		$(SDK_ROOT)/libs/apu/acl_target/build-apu-tct-sa-d/libacl_target.a \
...
ocl_kernels_APU_LOAD.h : ocl_kernels_load.elf
	read_elf -pPMh=32 -mDMb=8 -mVMb=256 ocl_kernels_load.elf -eGb -t $(tcl_script) -Tload_name=APU_OCL > APU_OCL_LOAD.hpp
		
clean::
	rm -f $(KERNEL_EXES) *_apu_process_desc_main.* build_args.txt *.P *.c *.cpp *.map *.bcf
